...
extern EIF_TYPED_VALUE F869_7056(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7057(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7058(EIF_REFERENCE);
extern void F869_7714(EIF_REFERENCE, int);
...
RTOID (F869_7056)
EIF_TYPED_VALUE F869_7056 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12699);
	RTSA(Dtype(Current));
	RTSC;
...
RTOID (F869_7057)
EIF_TYPED_VALUE F869_7057 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12700);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12700);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F869_7058)
EIF_TYPED_VALUE F869_7058 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12701);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12701);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F869_7714 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 868, Current, 0, 7713);
	RTSA(dtype);
	RTME(dtype, 0);
...
{
	GTCX
	RTOTS (7056,F869_7056)
	RTOTS (7057,F869_7057)
	RTOTS (7058,F869_7058)
}
