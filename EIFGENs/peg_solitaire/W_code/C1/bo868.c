...
extern void F868_7713(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 867, Current, 0, 0, 12697);
	RTSA(Dtype(Current));
	RTSC;
...
void F868_7713 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 867, Current, 0, 7712);
	RTSA(dtype);
	RTME(dtype, 0);
