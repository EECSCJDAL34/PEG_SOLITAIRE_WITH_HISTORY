...
extern void F867_7713(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 866, Current, 0, 0, 12695);
	RTSA(Dtype(Current));
	RTSC;
...
void F867_7713 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 866, Current, 0, 7712);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4981, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	if (RTCEQ(tr1, tr2)) {
		RTCK;
	} else {
		RTCF;
