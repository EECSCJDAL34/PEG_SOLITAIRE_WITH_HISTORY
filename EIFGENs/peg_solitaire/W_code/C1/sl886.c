...
extern EIF_TYPED_VALUE F886_7233(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F886_7233 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 885, Current, 0, 1, 12850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(885, Current, 12850);
