...
EIF_TYPED_VALUE _A893_76 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5187, "test", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI move_left_messages */
EIF_TYPED_VALUE _A893_77 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5188, "move_left_messages", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_SOLITAIRE_UI move_right_messages */
EIF_TYPED_VALUE _A893_78 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5189, "move_right_messages", closed [1].it_r))(closed [1].it_r);
}
